...
// Helpers locaux
let _eid = 0;
const mkBut = (joueurId, phase = "temps_reglementaire") => ({ id: `m-e${_eid++}`, joueurId, type: "but", phaseJeu: phase, officiel: true, minutesJouees: 90 });
const mkAssist = (joueurId) => ({ id: `m-e${_eid++}`, joueurId, type: "assist", phaseJeu: "temps_reglementaire", officiel: true, minutesJouees: 90 });
const mkPreAss = (joueurId) => ({ id: `m-e${_eid++}`, joueurId, type: "pre_assist", phaseJeu: "temps_reglementaire", officiel: true, minutesJouees: 90 });
const mkArret = (joueurId) => ({ id: `m-e${_eid++}`, joueurId, type: "arret", phaseJeu: "temps_reglementaire", officiel: true, minutesJouees: 90 });
// ---------------------------------------------------------------------------
