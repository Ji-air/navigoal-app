...
const ETATS_INIT: Record<string, MatchEtat> = {
  m1: {
    ...
    impulsions: [
      { id: 'i1',  nationId: 'france',    poste: 'Captain',   joueurNom: 'Mbappé',      type: 'but',         nm: 10, palier: 'Breeze' },
      { id: 'i2',  nationId: 'france',    poste: 'Second',    joueurNom: 'Griezmann',   type: 'assist',      nm: 10, palier: 'Breeze' },
      { id: 'i3',  nationId: 'france',    poste: 'Navigator', joueurNom: 'Griezmann',   type: 'pre_assist',  nm: 10, palier: 'Breeze' },
      { id: 'i4',  nationId: 'france',    poste: 'Watch',     joueurNom: 'Upamecano',   type: 'clean_sheet', nm: 10, palier: 'Breeze' },
      { id: 'i5',  nationId: 'france',    poste: 'Keeper',    joueurNom: 'Maignan',     type: 'arret',       nm: 10, palier: 'Breeze' },
      { id: 'i6',  nationId: 'allemagne', poste: 'Captain',   joueurNom: 'Havertz',     type: 'but',         nm: 20, palier: 'Wind'   },
      { id: 'i7',  nationId: 'allemagne', poste: 'Second',    joueurNom: 'Kimmich',     type: 'assist',      nm: 20, palier: 'Wind'   },
    ],
  },
  m2: {
    matchId: 'm2',
    ...
    vainqueurTirsAuBut: null,
    impulsions: [
      { id: 'i8',  nationId: 'bresil',    poste: 'Captain',   joueurNom: 'Vinicius Jr', type: 'but',         nm: 20, palier: 'Wind'   },
      { id: 'i9',  nationId: 'bresil',    poste: 'Second',    joueurNom: 'Paquetá',     type: 'but',         nm: 20, palier: 'Wind'   },
      { id: 'i10', nationId: 'bresil',    poste: 'Keeper',    joueurNom: 'Alisson',     type: 'arret',       nm: 20, palier: 'Wind'   },
      { id: 'i11', nationId: 'espagne',   poste: 'Captain',   joueurNom: 'Morata',      type: 'but',         nm: 20, palier: 'Wind'   },
      { id: 'i12', nationId: 'espagne',   poste: 'Second',    joueurNom: 'Pedri',       type: 'assist',      nm: 20, palier: 'Wind'   },
    ],
  },
  m3: {
    matchId: 'm3',
